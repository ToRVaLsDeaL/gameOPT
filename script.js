...
window.addEventListener('load', function(){
    ...
    class Player{
        constructor(game){
            ...
            this.frameX = 0;
            this.frameY = 0;
            this.maxFrame = 50; // Se aumenta el numero de municiones
        }
    ...
    class Enemy {
        constructor(game){
            ...
            this.speedX = Math.random() * - 1 - 0.5; // se aumenta la velocidad de los enemigos para mayor dificultad
            this.markedForDeletion = false;
            this.lives = 2; // se otorgan 2 vidas
    ...
    class Angler1 extends Enemy {
        constructor(game){
            ...
            this.lives = 5 // se aumentan las vidas del enemigo
        }
    }
    ...
    class Angler2 extends Enemy {
        constructor(game){
            ...
            this.lives = 7; // se aumenta vida del enemigo
        }
    }
    ...
    class Layer {
        ...
        // este dibuja el escenario en pantalla
        draw(context){
    ...
    class Game{
        constructor(width, height){
            ...
            this.speed = 1.5; // se aumenta la velocidad de recarga
            this.energy = 0;
            this.debug = true;
        ...
        // aparicion en las balas y enemigos
        update(deltaTime){
